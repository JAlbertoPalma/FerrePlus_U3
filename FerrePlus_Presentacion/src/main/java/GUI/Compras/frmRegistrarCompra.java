...
public class frmRegistrarCompra extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTableCompras.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "SKU", "Nombre", "Cantidad", "PrecCompra", "Subtotal"
            }
        ) {
        ...
        txtTotalCompra.setPreferredSize(new java.awt.Dimension(200, 50));
        pnlFondo.add(txtTotalCompra, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 490, 190, 22));
        ...
        jButtonAgregar.setBackground(new java.awt.Color(255, 204, 153));
...
//         Columna 2
        ...
        gbc.gridy++;
        this.pnlFondo.add(this.txtTotalCompra, gbc);
        gbc.gridy++;
