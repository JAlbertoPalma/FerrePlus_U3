...
/**
 * /**
 * Data Transfer Object (DTO) que representa la información completa de un
 * producto, incluyendo su identificador único (`id`). Se utiliza para
 * transferir datos de productos existentes entre las capas de la aplicación.
 *
 * @author Beto_
 */
public class ProductoDTO {
    ...
    public ProductoDTO(String SKU, String nombre, String categoria, String unidadMedida, Double precioCompraReferencial, Double precioVenta, String proveedor, Integer stock, String observaciones) {
        this.SKU = SKU;
        this.nombre = nombre;
    ...
    public ProductoDTO(String id, String SKU, String nombre, String categoria, String unidadMedida, Double precioCompraReferencial, Double precioVenta, String proveedor, Integer stock, LocalDateTime fechaHoraAlta, Boolean estado, String observaciones) {
        this.id = id;
        this.SKU = SKU;
        this.nombre = nombre;
        this.categoria = categoria;
